...
public class PaymentPage {
    ...
    private SelenideElement cardHolderField = Selenide.$x("//span[text()='Владелец']/following-sibling::span/input");
    ...
    private SelenideElement errMsgWithDecline = Selenide.$x("//div[text()='Ошибка!" +
    ...
    public void insertValidPaymentCardDataForBank(DataGenerator.CardInfo cardInfo) {
    ...
    public void checkErrorMsgDeclineFromBank() {
        errMsgWithDecline.shouldBe(visible);
    }

    public void checkApprovedMsgFromBank() {
        approvedMsg.shouldBe(visible);
    }
